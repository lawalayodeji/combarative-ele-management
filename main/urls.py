...
#          name='changePasswordFaculty'),
    ...
    path('register/', views.register_p, name='registerPage'),
    path('registerDep/', views.student_register_dep, name='registerDepart'),
    path('registerTeach/', views.register_teacher, name='registerTeacher'),
    path('otp_verification/', views.otp_verification, name='otpverification'),
    path('teachCourse/', views.teacher_course, name='teacherCourse'),
    path('Department-add/', views.addDepartment, name='Department_add'),
